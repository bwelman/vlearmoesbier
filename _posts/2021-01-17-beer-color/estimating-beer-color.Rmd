...
description: |
  Het originele artikel van Morey.
author:
  - name: Daniel Morey
...
```{r mcu-srm, fig.cap="Color Estimates Based on Recipe MCU.", fig.show='hold', fig.asp=0.618, fig.align='center', out.width="100%", echo=FALSE}
knitr::include_graphics("mcu-srm.png")
```
